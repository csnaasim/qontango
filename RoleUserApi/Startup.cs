...
using RoleUserApi.Authentication;
using RoleUserApi.Controllers;
...
namespace RoleUserApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //ali butt telerik related change
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Feature Role User API", Version = "v1" });
            ...
            //ali butt telerik related chnages
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Feature Role User Api V1");
            });
